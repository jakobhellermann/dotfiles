...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l exports -d 'If provided, the generated module will have exports with exactly the same names and types as those in the provided WebAssembly module. The implementation (e.g. function bodies, global initializers) of each export in the generated module will be random and unrelated to the implementation in the provided module. Only globals and functions are supported' -r -F
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l allow-start-export -d 'Determines whether a `start` export may be included. Defaults to `true`' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l allow-floats -d 'Determines whether we generate floating point instructions and types' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l bulk-memory-enabled -d 'Determines whether the bulk memory proposal is enabled for generating instructions' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l canonicalize-nans -d 'Returns whether NaN values are canonicalized after all f32/f64 operation. Defaults to false' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l disallow-traps -d 'Returns whether we should avoid generating code that will possibly trap' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l exceptions-enabled -d 'Determines whether the exception-handling proposal is enabled for generating instructions' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l export-everything -d 'Export all WebAssembly objects in the module. Defaults to false' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l gc-enabled -d 'Determines whether the GC proposal is enabled when generating a Wasm module' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l custom-page-sizes-enabled -d 'Determines whether the custom-page-sizes proposal is enabled when generating a Wasm module' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l generate-custom-sections -d 'Returns whether we should generate custom sections or not. Defaults to false' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l memory64-enabled -d 'Returns whether 64-bit memories are allowed. Defaults to true' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l memory-max-size-required -d 'Whether every Wasm memory must have a maximum size specified. Defaults to `false`' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l multi-value-enabled -d 'Determines whether the multi-value results are enabled' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l reference-types-enabled -d 'Determines whether the reference types proposal is enabled for generating instructions' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l relaxed-simd-enabled -d 'Determines whether the Relaxed SIMD proposal is enabled for generating instructions' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l saturating-float-to-int-enabled -d 'Determines whether the non-trapping float-to-int conversions proposal is enabled' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l sign-extension-ops-enabled -d 'Determines whether the sign-extension-ops proposal is enabled' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l shared-everything-threads-enabled -d 'Determines whether the shared-everything-threads proposal is enabled' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l simd-enabled -d 'Determines whether the SIMD proposal is enabled for generating instructions' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l tail-call-enabled -d 'Determines whether the tail calls proposal is enabled for generating instructions' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l table-max-size-required -d 'Whether every Wasm table must have a maximum size specified. Defaults to `false`' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l threads-enabled -d 'Determines whether the threads proposal is enabled' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l allow-invalid-funcs -d 'Indicates whether wasm-smith is allowed to generate invalid function bodies' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l wide-arithmetic-enabled -d 'Determines whether the [wide-arithmetic proposal] is enabled' -r -f -a "{true\t'',false\t''}"
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand smith" -l extended-const-enabled -d 'Determines whether the [extended-const proposal] is enabled' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand component; and __fish_seen_subcommand_from new" -l merge-imports-based-on-semver -d 'Indicates whether imports into the final component are merged based on semver ranges' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand component; and __fish_seen_subcommand_from link" -l merge-imports-based-on-semver -d 'Indicates whether imports into the final component are merged based on semver ranges' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand metadata; and __fish_seen_subcommand_from add" -l author -d 'Contact details of the people or organization responsible, encoded as a freeform string' -r
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand json-from-wast" -l allow-confusing-unicode -d 'Controls the "allow confusing unicode" option which will reject parsing files that have unusual characters' -r -f -a "{true\t'',false\t''}"
...
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a parse -d 'Parse the WebAssembly text format'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a validate -d 'Validate a WebAssembly binary'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a print -d 'Print the textual form of a WebAssembly binary'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a smith -d 'A WebAssembly test case generator'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a shrink -d 'Shrink a Wasm file while maintaining a property of interest (such as triggering a compiler bug)'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a mutate -d 'A WebAssembly test case mutator'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a dump -d 'Debugging utility to dump information about a wasm binary'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a objdump -d 'Dumps information about sections in a WebAssembly file'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a strip -d 'Removes custom sections from an input WebAssembly file'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a compose -d 'WebAssembly component composer'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a demangle -d 'Demangle Rust and C++ symbol names in the `name` section'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a component -d 'WebAssembly wit-based component tooling'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a metadata -d 'Manipulate metadata (module name, producers) to a WebAssembly file'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a wit-smith -d 'A WIT test case generator'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a addr2line -d 'Translate a WebAssembly address to a filename and line number using DWARF debugging information'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a completion -d 'Generate shell completion scripts for this CLI'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a json-from-wast -d 'Convert a `*.wast` WebAssembly spec test into a `*.json` file and `*.wasm` files'
complete -c wasm-tools -n "__fish_wasm_tools_using_subcommand help; and not __fish_seen_subcommand_from parse validate print smith shrink mutate dump objdump strip compose demangle component metadata wit-smith addr2line completion json-from-wast help" -f -a help -d 'Print this message or the help of the given subcommand(s)'
