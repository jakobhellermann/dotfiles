...
- Generalisiert, nicht overfittet: keine Vokabeln des konkreten Vorfalls (Feld-/Mechanismus-/
  Komponenten-Namen, Domain-Jargon). Test: würde die Regel denselben Fehler auch in einem fremden
  Projekt verhindern, und bleibt sie ohne den Vorfall-Kontext verständlich? Sonst abstrahieren.
